...
CREATE TABLE `Reservation` (
    ...
    `demande_special` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `Reservation` ADD CONSTRAINT `Reservation_voyageur_id_fkey` FOREIGN KEY (`voyageur_id`) REFERENCES `Comptes`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
